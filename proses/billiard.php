...
try {
    ...
    $query = "INSERT INTO billiard (email, name, phone, date, time, duration, alarm, status, pin) VALUES (?, ?, ?, ?, ?, ?, ?, 'proses', ?)";
    ...
    $query = "INSERT INTO history (jenis, email, name, phone, date, time, duration, alarm) VALUES ('billiard', ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($connection, $query);
