...
try {
    ...
    $query = "INSERT INTO futsal (email, name, phone, date, time, duration, alarm, status, pin) VALUES (?, ?, ?, ?, ?, ?, ?, 'proses', ?)";
    ...
    $query = "INSERT INTO history (jenis, email, name, phone, date, time, duration, alarm) VALUES ('futsal', ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($connection, $query);
