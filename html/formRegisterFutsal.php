...
<body>
  ...
  <div class="container form-container">
    <div class="form-box">
      ...
      <form action="../proses/futsal.php" method="post" role="form" class="php-email-form">
        ...
        <button type="submit" class="btn btn-primary" onclick="window.location.href='bookingberhasil.php'">Registrasi</button>
